...
public class FilterLiquorContAdapter extends RecyclerView.Adapter<FilterLiquorContAdapter.MyviewHolder> {

    Context context;
    Option filter_subCat;

    public FilterLiquorContAdapter(Context context, Option filter_subCat) {
    ...
    public MyviewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new FilterLiquorContAdapter.MyviewHolder(LayoutInflater.from(context).inflate(R.layout.recycler_filter_options,parent,false));
