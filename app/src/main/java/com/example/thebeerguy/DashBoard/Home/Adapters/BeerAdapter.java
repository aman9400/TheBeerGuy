...
public class BeerAdapter extends RecyclerView.Adapter<BeerAdapter.MyViewholder> {
    ...
    Context context;
    List<ResponseHome> BeerList;

    public BeerAdapter(Context context, List<ResponseHome> beerList) {
    ...
    public MyViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new BeerAdapter.MyViewholder(LayoutInflater.from(context).inflate(R.layout.sample_recycler2,parent,false));
    ...
    public void onBindViewHolder(@NonNull MyViewholder holder, int position) {
        ...
        ResponseHome responseHome = BeerList.get(position);
